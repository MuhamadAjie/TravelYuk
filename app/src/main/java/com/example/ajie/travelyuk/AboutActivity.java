...
public class AboutActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Uri gmmIntentUri;
    Intent mapIntent;
    String lokasi_saya = "Jl. Buyut Kaifah, Karanganyar, Kec. Karangbahagia, Bekasi, Jawa Barat 17530";
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_move_hp:
                String phoneNumber = "089522767180";
                Intent dialPhoneIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+phoneNumber));
                startActivity(dialPhoneIntent);
                break;

            case R.id.btn_move_sosmed:
                String url = "https://www.instagram.com/muhamadz_azie" ;
